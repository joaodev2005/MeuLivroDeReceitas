...
internal sealed class Argon2PasswordHasher : IPasswordHasher
{
    ...
    private const int MEMORY_SIZE = 1024 * 20; 
    ...
    public string HashPassword(string password)
    {
        ...
        Array.Copy(salt, 0, combinedBytes, 0, SALT_SIZE);  // salt nos bytes 0–15
        Array.Copy(hash, 0, combinedBytes, SALT_SIZE, HASH_SIZE);  // hash nos bytes 16–47
